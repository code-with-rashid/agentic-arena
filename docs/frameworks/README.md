...
| [Google ADK](google-adk.md) | runs 5 of 7 | The only **real** loop cap out of the box (N means N); needs `litellm` to leave Google, the heaviest dep tree here; loses both `res-01` and `res-02` to uncaught exceptions |
