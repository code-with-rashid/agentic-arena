...
|---|---|---|---|
| Models/gateways | Can my transport express the task? | [Choose](journeys/choose.md) | Shared mock/native API and subscription functional paths |
| Loops/frameworks | Who owns control and state? | [Learn](journeys/learn.md) | Adapters, architecture, and educational build path |
| Tools/protocols | Does a boundary preserve meaning? | [Connect](journeys/connect.md) | Local tools; scoped protocol lessons |
| Context/memory | What should be retained and retrieved? | [Build](journeys/build.md) | Fixed RAG and context-growth evidence; scoped lessons |
| Reliability | What happens when work fails? | [Debug](journeys/debug.md) | Retry, approval and restart findings |
| Execution/security | What authority and access does work have? | [Secure](journeys/secure.md) | Approval evidence; controlled boundary fixtures |
